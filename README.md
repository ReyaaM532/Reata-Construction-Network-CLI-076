...
| Subnet | Department                       | Network Address     | Subnet Mask       | Broadcast Address | Usable Host Range                 | Default Gateway  | VLAN |
| ------ | -------------------------------- | ------------------- | ----------------- | ----------------- | --------------------------------- | ---------------- | ---: |
| 1st    | Management                       | `192.168.38.0/27`   | `255.255.255.224` | `192.168.38.31`   | `192.168.38.2 – 192.168.38.30`    | `192.168.38.1`   |   10 |
| 2nd    | HR                               | `192.168.38.32/27`  | `255.255.255.224` | `192.168.38.63`   | `192.168.38.34 – 192.168.38.62`   | `192.168.38.33`  |   20 |
| 3rd    | Finance                          | `192.168.38.64/27`  | `255.255.255.224` | `192.168.38.95`   | `192.168.38.66 – 192.168.38.94`   | `192.168.38.65`  |   30 |
| 4th    | Procurement & Quantity Surveying | `192.168.38.96/27`  | `255.255.255.224` | `192.168.38.127`  | `192.168.38.98 – 192.168.38.126`  | `192.168.38.97`  |   40 |
